...
function Home() {
  ...
  return (
    <div className="page-container">
      ...
      {newsData !== null || coverArticles.length === 0 ? (
        <CoverArticleCarousel articlesData={coverArticles} key={"home"} />
      ) : (
        ""
      )}
      <ContentWrapper>
        ...
        <Banner height="120px" margin={"0"}></Banner>
      ...
      <Banner width="940px" height="120px" margin={"16px 0px 18px"}></Banner>
      <ImageCarousel />
    </div>
  );
}
