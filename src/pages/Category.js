...
function Category() {
    ...
    useEffect(()=>{
        articlesData !== null && setCoverArticles(getElementsWithKeyValue(articlesData, 'featured', true));
    }, [articlesData])
    ...
    return (
        <div className='page-container'>
            ...
            {articlesData !== null && coverArticles.length !== 0 ? <CoverArticleCarousel articlesData={coverArticles} key={categories[index].id}/> : ''}
             <ContentWrapper>
             {articlesData !== null ? <CategoryArticlesList categoryName={categories[index].name} articles={articlesData} /> : ''}
